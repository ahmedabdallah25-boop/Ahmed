# Next Slate — 10 uploads, pitched title-first

## How these are pitched, and why

MrBeast's production rule is that **the title and thumbnail are decided before the video is
made**, and if the packaging isn't compelling the video doesn't get produced. The video exists to
