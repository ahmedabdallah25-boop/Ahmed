...
> **Not channel content.** This folder is unrelated to Finance % Decoded and to HELD BY FAITH.
> It's a facilities brief for a back-of-house commercial laundry room, kept here for
> convenience. Nothing in it feeds either channel.
...
the visuals file (renders your actual room cleaned but otherwise unchanged — the picture that
justifies the rest of the budget).
