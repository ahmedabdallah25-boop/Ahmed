...
| [`.claude/skills/video-edit/`](.claude/skills/video-edit/) | **Agentic video editing skill** — deterministic word-safe cuts, motion graphics, captions, music/SFX ducking, QC gate, review room + taste memory. Works identically on any Claude model; start with `ve doctor` |
