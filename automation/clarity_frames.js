...
const F = [
  ...
  ['S089', 'cols',   { h: 'THE TURN',
      left:  { head: 'MECCA', items: [
        '<span class="ar gold" style="font-size:64px">يَا أَيُّهَا النَّاسُ</span>',
        'Short verses', 'Heavy rhyme', 'Oaths on dawn, sun, fig', 'The Hour · the orphan'] },
      right: { head: 'MEDINA', items: [
        '<span class="ar gold" style="font-size:64px">يَا أَيُّهَا الَّذِينَ آمَنُوا</span>',
        'Long verses', 'Rhyme thins', 'Conditions and exceptions', 'Inheritance · contracts'] } }],
